...
os.system('sudo ~/mhn/scripts/deploy_cowrie.sh '+ SERVER_BASE_URL +' '+ DEPLOY_KEY)
os.system('sudo ~/mhn/scripts/deploy_p0f.sh '+ SERVER_BASE_URL +' '+ DEPLOY_KEY)
...
os.system('sudo ~/mhn/scripts/deploy_amun.sh '+ SERVER_BASE_URL +' '+ DEPLOY_KEY)
